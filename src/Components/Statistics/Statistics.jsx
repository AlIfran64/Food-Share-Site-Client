    ...
    <div className="bg-[url('../../../src/assets/images/statsbg.jpg')] bg-cover bg-center bg-no-repeat">
      <div className="bg-[#D9224E]/80 py-14 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-white font-extrabold text-4xl lg:text-4xl text-center">Our Impact in Numbers</h1>
          <p className="text-white text-center text-md mt-3 mb-10">
          ...
          <div className="flex justify-between items-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-white text-lg">Meals Shared</p>
            </div>
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-white text-lg">Active Donors</p>
            </div>
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-white text-lg">Families Supported</p>
            </div>
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-white text-lg">Local Areas Covered</p>
            </div>
          </div>
        </div>
      </div>
