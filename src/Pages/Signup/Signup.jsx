...
const Signup = () => {
  ...
  const handleSignup = (e) => {
    ...
    // Destructure
    const { name, email, photo, password } = signupData;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-6 sm:p-8 my-10">
        {/* Heading */}
        <div className="mb-6 text-center">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Create Your Account</h1>
          <p className="text-sm text-gray-500 mt-1">Join us to access exclusive features</p>
        </div>
